...
setup(
    name="energy_analysis_BB",
    version="0.0.1",
    description="This package provides the energy_analysis Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, energy_analysis",
    package_dir={"": "src"},
    ...
    package_data={
        "energy_analysis_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "energy_analysis_BB=energy_analysis_BB.__main__:main",
        ],
    },
    project_urls={
