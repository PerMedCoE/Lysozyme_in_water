...
setup(
    name="add_solvate_BB",
    version="0.0.1",
    description="This package provides the add_solvate Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, add_solvate",
    package_dir={"": "src"},
    ...
    package_data={
        "add_solvate_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "add_solvate_BB=add_solvate_BB.__main__:main",
        ],
    },
    project_urls={
