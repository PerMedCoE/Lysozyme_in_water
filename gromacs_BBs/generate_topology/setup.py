...
setup(
    name="generate_topology_BB",
    version="0.0.1",
    description="This package provides the generate_topology Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, generate_topology",
    package_dir={"": "src"},
    ...
    package_data={
        "generate_topology_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "generate_topology_BB=generate_topology_BB.__main__:main",
        ],
    },
    project_urls={
