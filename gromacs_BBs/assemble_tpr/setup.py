...
setup(
    name="assemble_tpr_BB",
    version="0.0.1",
    description="This package provides the assemble_tpr Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, assemble_tpr",
    package_dir={"": "src"},
    ...
    package_data={
        "assemble_tpr_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "assemble_tpr_BB=assemble_tpr_BB.__main__:main",
        ],
    },
    project_urls={
