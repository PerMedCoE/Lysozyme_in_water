...
setup(
    name="energy_minimization_BB",
    version="0.0.1",
    description="This package provides the energy_minimization Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, energy_minimization",
    package_dir={"": "src"},
    ...
    package_data={
        "energy_minimization_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "energy_minimization_BB=energy_minimization_BB.__main__:main",
        ],
    },
    project_urls={
