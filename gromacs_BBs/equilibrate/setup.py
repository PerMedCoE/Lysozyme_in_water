...
setup(
    name="equilibrate_BB",
    version="0.0.1",
    description="This package provides the equilibrate Building Block",
    ...
    keywords="BuildingBlock, PerMedCoE, equilibrate",
    package_dir={"": "src"},
    ...
    package_data={
        "equilibrate_BB": [ # "assets/*",
                           "definition.json"],
    },
    entry_points={
        "console_scripts": [
            "equilibrate_BB=equilibrate_BB.__main__:main",
        ],
    },
    project_urls={
